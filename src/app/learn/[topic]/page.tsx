...
export default function LearnPage() {
  ...
  const handleSaveProgress = async () => {
    if (isAuthenticated && user) {
      const progressData = {
        completedModules: [], // Add logic to track completed modules
        lastActiveModule: selectedNode,
        streakCount: 0, // Add logic to track streaks
      };

      try {
        await setDoc(doc(db, "userProgress", user.uid), progressData, { merge: true });
